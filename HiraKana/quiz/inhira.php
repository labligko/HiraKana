...
<html>
<head>
    <title>Intermediate Hiragana</title>
...
<body onload="NextQuestion(0)">
    ...
    <div class="banner">
        <video autoplay loop muted>
            <source src="../quiz/japanese-store.mp4">
        </video>
    ...
    <main>
        ...
        <div class="game-quiz-container">
            ...
            <div class="game-details-container">
                ...
                <div id="timer">Waktu: <span id="countdown">15</span> detik</div>
    ...
    <script src="inhiraquiz.js"></script>
</body>
</html>